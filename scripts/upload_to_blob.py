...
# --- FIX: Get the correct temporary directory for the current OS ---
...
sample = df.tail(36)
sample_path = os.path.join(temp_dir, "master_df_sample.csv")
...
if os.path.exists("data/processed/current_price.json"):
    ...
    tmp_path = os.path.join(temp_dir, "current_price.json")
